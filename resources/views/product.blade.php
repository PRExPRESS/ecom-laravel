                        ...
                        <div class="tf-product-info-wrap position-relative">
                            ...
                            <div class="tf-product-info-list">
                                ...
                                <div class="tf-product-info-price">
                                    <div class="price-on-sale">LKR {{ $product->price }}</div>
                                ...
                                <div class="tf-product-info-variant-picker">
                                    <div class="variant-picker-item">
                                        <div class="variant-picker-label">
                                            Color: <span
                                                class="fw-6 variant-picker-label-value ">{{ explode(',', $product->colors)[0] }}</span>
                                        </div>
                                        <div class="variant-picker-values">

                                            <label class="hover-tooltip radius-60 color-btn" for="values-brown">
                                                <span class="btn-checkbox "
                                                    style="background-color:{{ $product->colors }};"></span>
                                                <span class="tooltip">{{ $product->colors }}</span>
                                            </label>
                                    ...
                                    <div class="variant-picker-item">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="variant-picker-label">
                                                Size: <span
                                                    class="fw-6 variant-picker-label-value">{{ explode(', ', $product->sizes)[0] }}</span>
                                            </div>
                                ...
                                <div class="tf-product-info-buy-button">
                                    <form class="">
                                        ...
                                        <a href="javascript:void(0);"
                                            class="tf-btn btn-fill justify-content-center fw-6 fs-16 flex-grow-1 animate-hover-btn btn-add-to-cart add-to-cart" data-product='{{ json_encode($product_for_cart) }}'><span>Add
                                                to cart -&nbsp;</span><span class="tf-qty-price total-price">LKR
                                        ...
                                        <div class="w-100">
                                            <a href="/checkout" class="btns-full">Buy with <img
                                                    src="{{ asset('images/payments/visa.png') }}" alt=""></a>
                                    ...
                                    <div class="reply-comment cancel-review-wrap">
                                        ...
                                        <div class="reply-comment-wrap">
                                            ...
                                            <div class="reply-comment-item">
                                                <div class="user">
                                                    <span class="link">{{ $review->fname.' '.$review->lname }}</span>
                                                    
                                                </div>
                                                <p class="text_black-3">{{ $review->review }}</p>
                                            </div>
