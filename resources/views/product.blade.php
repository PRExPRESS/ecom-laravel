                            ...
                            <div dir="ltr" class="swiper tf-product-media-thumbs" data-direction="vertical">
                                <div class="swiper-wrapper stagger-wrap">
                                    ...
                                    <div class="swiper-slide stagger-item" data-color="brown">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('images/products/brown.jpg') }}" src="{{ asset('images/products/brown.jpg') }}" alt="img-product">
                                        </div>
                                    </div>
                                    <!-- purple -->
                                    <div class="swiper-slide stagger-item" data-color="purple">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('images/products/purple.jpg') }}" src="{{ asset('images/products/purple.jpg') }}" alt="img-product">
                                        </div>
                                    </div>
                                    <!-- light green -->
                                    <div class="swiper-slide stagger-item" data-color="green">
                                        <div class="item">
                                            <img class="lazyload" data-src="{{ asset('images/products/green.jpg') }}" src="{{ asset('images/products/green.jpg')  }}" alt="img-compare">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div dir="ltr" class="swiper tf-product-media-main" id="gallery-swiper-started">
                                <div class="swiper-wrapper" >
                                    ...
                                    <div class="swiper-slide" data-color="brown">
                                        <a href="{{ asset('images/products/brown.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                            <img class="tf-image-zoom-magnifier lazyload" data-zoom="{{ asset('images/products/brown.jpg') }}" data-src="{{ asset('images/products/brown.jpg') }}" alt="img-product">
                                        </a>
                                    </div>
                                    <!-- purple -->
                                    <div class="swiper-slide" data-color="purple">
                                        <a href="{{ asset('images/products/purple.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                            <img class="tf-image-zoom-magnifier lazyload" data-zoom="{{ asset('images/products/purple.jpg') }}" data-src="{{ asset('images/products/purple.jpg') }}" alt="img-product">
                                        </a>
                                    </div>
                                    <!-- light green -->
                                    <div class="swiper-slide" data-color="green">
                                        <a href="{{ asset('images/products/green.jpg') }}" target="_blank" class="item" data-pswp-width="770px" data-pswp-height="1075px">
                                            <img class="tf-image-zoom-magnifier lazyload" data-zoom="{{ asset('images/products/green.jpg') }}" data-src="{{ asset('images/products/green.jpg') }}" alt="img-product">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="tf-product-info-list">
                            ...
                            <div class="tf-product-info-buy-button">
                                <form class="">
                                    ...
                                    <div class="w-100">
                                        <a href="#" class="btns-full">Buy with <img src="{{ asset('images/payments/visa.png') }}" alt=""></a>
                            ...
                            <div class="tf-product-info-extra-link">
                                <a href="#compare_color" data-bs-toggle="modal" class="tf-product-extra-icon">
                                    <div class="icon">
                                        <img src="{{ asset('images/item/compare.svg') }}" alt="">
                                    </div>
            ...
            <div class="tf-height-observer w-100 d-flex align-items-center">
                <div class="tf-sticky-atc-product d-flex align-items-center">
                    <div class="tf-sticky-atc-img">
                        <img class="lazyloaded" data-src="{{ asset('images/shop/products/p-d1.png') }}" alt="" src="{{ asset('images/shop/products/p-d1.png') }}">
                    </div>
                                ...
                                <div class="reply-comment cancel-review-wrap">
                                    ...
                                    <div class="reply-comment-wrap">
                                        <div class="reply-comment-item">
                                            <div class="user">
                                                <div class="image">
                                                    <img src="{{ asset('images/collections/collection-circle-10.jpg') }}" alt="">
                                                </div>
                                                <div>
                                                    <h6>
                                        ...
                                        <div class="reply-comment-item type-reply">
                                            <div class="user">
                                                <div class="image">
                                                    <img src="{{ asset('images/collections/collection-circle-9.jpg') }}" alt="">
                                                </div>
                                                <div>
                                                    <h6>
                                        ...
                                        <div class="reply-comment-item">
                                            <div class="user">
                                                <div class="image">
                                                    <img src="{{ asset('images/collections/collection-circle-8.jpg') }}" alt="">
                                                </div>
                                                <div>
                                                    <h6>
                                                        <a href="#" class="link">Superb quality apparel that exceeds expectations</a>
