...
<head>
    ...
    <!-- Animation css -->
    <link rel="stylesheet" href="{{ asset("admin-assets/vendor/animation/animate.min.css") }}">
    ...
    <!--flag Icon css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/flag-icons-master/flag-icon.css') }}">

    <!-- tabler icons-->
    {{-- <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/tabler-icons/tabler-icons.css') }}"> --}}

    <!-- prism css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/prism/prism.min.css') }}">

    <!-- apexcharts css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/apexcharts/apexcharts.css') }}">

    <!-- glight css -->
    <link rel="stylesheet" href="{{ asset('/admin-assets/vendor/glightbox/glightbox.min.css') }}">
    ...
    <!-- Data Table css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/datatable/jquery.dataTables.min.css') }}">

    <!-- Bootstrap css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/bootstrap/bootstrap.min.css') }}">

    <!-- vector map css -->
    <link rel="stylesheet" href="{{ asset('/admin-assets/vendor/vector-map/jquery-jvectormap.css') }}">

    <!-- apexcharts css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/apexcharts/apexcharts.css') }}">

    <!-- simplebar css-->
    <link rel="stylesheet" type="text/css" href="{{ asset('/admin-assets/vendor/simplebar/simplebar.css') }}">
...
<body>
        ...
        <nav>
            ...
            <div class="app-nav" id="app-simple-bar">
                <ul class="main-nav p-0 mt-2">
                    <li>
                        <a class="" data-bs-toggle="collapse" href="#dash" aria-expanded="false">
                    ...
                    <li>
                        <a class="" data-bs-toggle="collapse" href="#category" aria-expanded="false">
                    ...
                    <li>
                        <a class="" data-bs-toggle="collapse" href="#brand" aria-expanded="false">
                            <i class="ph-duotone  ph-flag-banner"></i>
                            Brands
                        </a>
                        <ul class="collapse" id="brand">
                            <li><a href="/admin/brands/">Brands</a></li>
                            <li><a href="/admin/brands/create">Add Brand</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="" data-bs-toggle="collapse" href="#prod" aria-expanded="false">
                            <i class="ph-duotone  ph-basket"></i>
                            Products
                        </a>
                        <ul class="collapse" id="prod">
                            <li><a href="/admin/products/">Products</a></li>
                            <li><a href="/admin/products/create">Add Category</a></li>
                        </ul>
                    </li>
                    <li>
                        <a class="" data-bs-toggle="collapse" href="#order" aria-expanded="false">
                            ...
                            <div class="col-6 col-sm-8 d-flex align-items-center justify-content-end header-right p-0">
                                ...
                                <ul class="d-flex align-items-center">
                                    ...
                                    <li class="header-cloud">
                                        <a href="#" class="head-icon" role="button"
                                            data-bs-toggle="offcanvas" data-bs-target="#cloudoffcanvasTops"
                                                ...
                                                <div class="cloud-body">
                                                    ...
                                                    <div class="cloud-content-box">
                                                        <div class="cloud-box bg-primary-900">
                                                            ...
                                                            <p class="f-s-13 mt-3"><i class="wi wi-raindrop"></i> 2%
                                                            </p>
                                                        </div>
                                                        ...
                                                        <div class="cloud-box bg-primary-700">
                                                            ...
                                                            <span>
                                                                <i
                                                                    class="ph-duotone  ph-sun-dim text-white f-s-25"></i>
                                                            </span>
                                                            <p class="f-s-13 mt-3"><i class="wi wi-raindrop"></i> 1%
                                                            </p>
                                                        </div>
                                    ...
                                    <li class="header-language">
                                        <div id="lang_selector" class="flex-shrink-0 dropdown">
                                            <a href="#" class="d-block head-icon ps-0"
                                                        ...
                                                        <li class="search-list-item">
                                                            ...
                                                            <div class="search-list-content">
                                                                <a href="sign_in.html" target="_blank">
                                                                    <h6 class="mb-0 text-dark">authentication methods
                                                                    </h6>
                                                                </a>
                                    ...
                                    <li class="header-apps">
                                        <a href="#" class="d-block head-icon" role="button"
                                            data-bs-toggle="offcanvas" data-bs-target="#appscanvasRights"
                                                ...
                                                <div class="row row-cols-3">
                                                    ...
                                                    <div class="d-flex-center text-center mb-3">
                                                        <a href="calendar.html" target="_blank">
                                                            <span>
                                                                <i
                                                                    class="ph-duotone  ph-calendar text-dark f-s-30"></i>
                                                            </span>
                                        ...
                                        {{-- <div class="offcanvas offcanvas-end header-cart-canvas" tabindex="-1"
                                            ...
                                            <div class="offcanvas-body app-scroll p-0">
                                                <div class="head-container">
                                                    <div class="head-box">
                                                        <img src="{{ asset('/admin-assets/images/ecommerce/19.jpg') }}" alt="cart"
                                                    ...
                                                    <div class="head-box">
                                                        <img src="{{ asset('/admin-assets/images/ecommerce/13.jpg') }}" alt="cart"
                                                ...
                                                <div class="head-container">
                                                    ...
                                                    <div class="notification-message head-box">
                                                        <div class="message-images">
                                                            <span
                                                                class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                                                <img src="../assets/images/ai_avtar/2.jpg"
                                                                    alt="" class="img-fluid b-r-10">
                                                                <span
                                                        ...
                                                        <div class="message-content-box flex-grow-1 ps-2">
                                                            ...
                                                            <span class="badge text-light-secondary mt-2"> 30
                                                                min</span>
                                                    ...
                                                    <div class="notification-message head-box">
                                                        <div class="message-images">
                                                            <span
                                                                class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                                                <img src="../assets/images/ai_avtar/5.jpg"
                                                                    alt="" class="img-fluid b-r-10">
                                                                <span
                                                                    class="position-absolute end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                                                            </span>
                                                        ...
                                                        <div class="message-content-box flex-grow-1 ps-2">
                                                            <a href="read_email.html"
                                                                class="f-s-15 text-secondary mb-0"><span
                                                                    class="f-w-500 text-secondary">Becky G.
                                                                    Hayes</span> has added a comment to <span
                                                                    class="f-w-500 text-secondary">Final_Report.pdf</span></a>
                                                            <span class="badge text-light-secondary mt-2"> 45
                                                                min</span>
                                                        </div>
                                                        <div class="align-self-start text-end">
                                                            <i class="ph ph-trash f-s-18 text-danger close-btn"></i>
                                                    ...
                                                    <div class="notification-message head-box">
                                                        <div class="message-images">
                                                            <span
                                                                class="bg-secondary h-35 w-35 d-flex-center b-r-10 position-relative">
                                                                <img src="../assets/images/ai_avtar/1.jpg"
                                                                    alt="" class="img-fluid b-r-10">
                                                                <span
                                                                    class="position-absolute  end-0 p-1 bg-secondary border border-light rounded-circle notification-avtar"></span>
                                                            </span>
                                                        ...
                                                        <div class="message-content-box flex-grow-1 ps-2">
                                                            <a href="read_email.html"
                                                                class="f-s-15 text-secondary mb-0"><span
                                                                    class="f-w-600 text-secondary">Romaine
                                                                    Nadeau</span> invited you to join a meeting
                                                            </a>
                                                            <div>
                                                                <a class="d-inline-block f-w-500 text-success me-1"
                                                                    href="#">Join</a>
                                    ...
                                    <li class="header-profile">
                                        <a href="#" class="d-block head-icon" role="button"
                                            data-bs-toggle="offcanvas" data-bs-target="#profilecanvasRight"
                                            aria-controls="profilecanvasRight">
                                            <img src="{{ asset('/admin-assets/images/avtar/woman.jpg') }}" alt="avtar"
                                                ...
                                                <ul class="">
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <a class="f-w-500" role="button" href="setting.html"
                                                                target="_blank" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="ph-duotone  ph-eye-slash pe-1 f-s-20"></i>
                                                                Hide Settings
                                                            </a>
                                                            <div class="flex-shrink-0">
                                                                <div class="form-check form-switch">
                                                                    <input class="form-check-input form-check-primary"
                                                                        type="checkbox" id="hideSetting" checked>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div
                                                            ...
                                                            <a class="f-w-500" href="#">
                                                                <i
                                                                    class="ph-duotone  ph-notification pe-1 f-s-20"></i>
                                                                Notification
                                                            </a>
                                                            <div class="flex-shrink-0">
                                                                <div class="form-check form-switch">
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <div>
                                                                <a class="f-w-500" href="#">
                                                                    <i
                                                                        class="ph-duotone  ph-detective pe-1 f-s-20"></i>
                                                                    Incognito
                                                                </a>
                                                            </div>
                                                            <div class="flex-shrink-0">
                                                    ...
                                                    <li>
                                                        <a class="mb-0 text-danger" href="/admin/logout"
                                                            >
                                                            <i class="ph-duotone  ph-sign-out pe-1 f-s-20"></i> Log
                                                            Out
                                                        </a>
    ...
    <script src="{{ asset('/admin-assets/vendor/vector-map/jquery-jvectormap-2.0.5.min.js') }}"></script>
    <script src="{{ asset('/admin-assets/vendor/vector-map/jquery-jvectormap-world-mill.js') }}"></script>

    <!-- slick-file -->
    <script src="{{ asset('/admin-assets/vendor/slick/slick.min.js') }}"></script>

    <!--cleave js  -->
    {{-- <script src="{{ asset('/admin-assets/vendor/cleavejs/cleave.min.js') }}"></script> --}}
    ...
    <!-- prism js-->
    <script src="{{ asset('/admin-assets/vendor/prism/prism.min.js') }}"></script>
