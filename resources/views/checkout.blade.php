    ...
    <div class="container">
        <div class="tf-page-cart-wrap layout-2">
            <div class="tf-page-cart-item">
                ...
                <form class="form-checkout" id="checkout-form" action="/checkout" method="post">
                    <div class="box grid-2">
                        <fieldset class="fieldset">
                            <label for="first-name">First Name</label>
                            <input type="text" id="first-name" placeholder="" value="{{ Auth::user()->fname }}">
                        </fieldset>
                        <fieldset class="fieldset">
                            <label for="last-name">Last Name</label>
                            <input type="text" id="last-name" placeholder="" value="{{ Auth::user()->lname }}">
                        </fieldset>
                    </div>
            ...
            <div class="tf-page-cart-footer">
                <div class="tf-cart-footer-inner">
                    ...
                    <form class="tf-page-cart-checkout widget-wrap-checkout" action="/checkout" method="post">
                        @csrf
                            ...
                            @foreach ($cart as $item  )
                                <li class="checkout-product-item">
                                    ...
                                    <div class="content">
                                        ...
                                        <span class="price">LKR{{ number_format($item['price']*$item['quantity'],2) }}</span>
                                    </div>
                                </li>
                            @endforeach
                        ...
                        <div class="d-flex justify-content-between line pb_20">
                            ...
                            <h6 class="total fw-5">LKR{{ number_format($total,2) }}</h6>
                        </div>
                        ...
                        <button class="tf-btn radius-3 btn-fill btn-icon animate-hover-btn justify-content-center" type="submit">Place order</button>
                    </form>
                </div>
            </div>
        </div>
