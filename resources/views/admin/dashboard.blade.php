                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                <a href="#" class="text-primary" role="button"
                                    ...
                                    Total <i class="ti ti-chevron-down ms-1"></i>
                                </a>
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu  dropdown-menu-end">
                                    ...
                                    <li><a class="dropdown-item" href="#">March</a>
                                    </li>
                                    <li><a class="dropdown-item" href="#">April</a>
                                    </li>
            ...
            <div class="card-body">
                ...
                <div class="d-flex gap-2 mt-3">
                    <div class="active-user-content">
                        <h2 class="text-primary mb-0">{{ $usersCount }}</h2>
